...
def generate_launch_description():
    ...
    return LaunchDescription([
        Node(package="libmotioncapture", executable="mocap_bridge.py", name="mocap_bridge", output="screen", parameters=[mocap_params]),
        Node(package="px4_hummingbird_opti", executable="mocap_to_px4", name="mocap_to_px4", output="screen", parameters=[converter_params]),
    ])
